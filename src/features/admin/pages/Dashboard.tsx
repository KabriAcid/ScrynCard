    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="lg:col-span-1">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>Latest card redemptions</CardDescription>
            </div>
            <Button
              variant="ghost"
              size="sm"
        ...
        <Card className="lg:col-span-1">
          ...
          <CardContent>
            {pendingFraudAlerts.length > 0 ? (
              <div className="space-y-3">
                {pendingFraudAlerts.slice(0, 3).map((alert) => (
                  <div
                    key={alert.id}
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  stats.openFraudAlerts > 0 ? "destructive" : "secondary"
                }
              >
        ...
        <Card className="lg:col-span-1">
          <CardHeader className="flex flex-row items-center justify-between">
            <div>
              ...
              <CardDescription>
                Politicians awaiting verification
              </CardDescription>
            </div>
            <Button
              variant="ghost"
          ...
          <CardContent>
            {pendingPoliticians.length > 0 ? (
              <div className="space-y-3">
                {pendingPoliticians.slice(0, 3).map((politician) => (
                  <div
                    key={politician.id}
                    className="flex items-center justify-between rounded-lg border p-3 hover:bg-accent/50 transition-colors"
                  >
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  pendingPoliticians.length > 0 ? "secondary" : "outline"
                }
                className={
                  pendingPoliticians.length > 0
